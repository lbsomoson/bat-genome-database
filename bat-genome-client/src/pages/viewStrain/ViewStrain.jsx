...
export default function ViewStrain() {
	...
	const columns = [
		...
		},
		{
			...
			minWidth: 80,
			getActions: (params) => [
				<GridActionsCellItem icon={<VisibilityIcon color={"primary"} />} label="View User Details" />,
				<GridActionsCellItem icon={<EditIcon color={"primary"} />} label="Edit" />,
				<GridActionsCellItem icon={<DeleteIcon color={"primary"} />} label="Delete" />,
			],
		},
	];
	return (
		<ThemeProvider theme={theme}>
			<Box sx={{ display: "flex", flexDirection: "column", mx: "150px", my: "80px" }}>
				<Typography variant={"h3"} fontWeight={"bold"} color={theme.palette.primary.main} mb={5}>
					Strain Database
					<br />
					<input
						name="search_term"
